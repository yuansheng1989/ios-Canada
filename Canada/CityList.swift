...
class CityListBase: UITableViewController, AddCityDelegate {
    ...
    override func viewDidLoad() {
        ...
        items = m.citiesByid(selectedProvince.id)!
        // Alternatives...
        items = m.citiesSortedById(selectedProvince.id)
        items = m.citiesSortedByName(selectedProvince.id)
    ...
    func addTask(_ controller: UIViewController, didSave item: City) {
        ...
        if m.cityAdd(selectedProvince.id, item) != nil {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toCityScene" {
            ...
            let vc = segue.destination as! CitySceneBase
